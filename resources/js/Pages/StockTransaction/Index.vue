            ...
            <tbody class="text-[13px] font-normal">
              ...
              >
                ...
                <td class="p-4 border-gray-200">
                  <span :class="{
                                        'bg-green-100 text-green-800 dark:bg-green-700 dark:text-green-300 me-2 px-2.5 py-0.5 rounded':
                                            stock.transaction_type === 'Added',
                                        'bg-red-100 text-red-800 dark:bg-red-700 dark:text-red-300 me-2 px-2.5 py-0.5 rounded':
                                            stock.transaction_type === 'Deducted',
                                        'bg-yellow-100 text-yellow-800 dark:bg-yellow-700 dark:text-yellow-300 me-2 px-2.5 py-0.5 rounded':
                                            stock.transaction_type === 'Sold',
                                        'bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300 me-2 px-2.5 py-0.5 rounded':
                                            stock.transaction_type === 'Deleted' ||
                                
                                            !stock.transaction_type,
                                    }" class="bg-red-100 text-red-800 dark:bg-red-700 dark:text-white  me-2 px-2.5 py-0.5 rounded">
