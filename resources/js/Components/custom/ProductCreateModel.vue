<template>
      ...
      <Dialog class="relative z-10" @close="$emit('update:open', false)">
         ...
         <div class="fixed inset-0 z-10 flex items-center justify-center">
            <TransitionChild
               ...
               >
               <DialogPanel
                  class="bg-black border-4 border-blue-600 rounded-[20px] shadow-xl w-5/6 lg:w-4/6 p-10 text-center"
                  >
  ...
  <!-- ✅ Unit Dropdown (Only visible when 'Weight Based' is selected) -->
      ...
      {{ form.errors.unit_id }}
                        ...
                        <div>
                           <div class="flex items-center gap-8">
                              ...
                              <div class="w-full">
                                 <label class="block text-md font-medium text-gray-300">Expire Date Margin (Days):</label>
                                 <input
                        ...
                        <div class="flex items-center gap-8 mt-6">
                           ...
                           <div class="w-full">
                              ...
                              <input
                                 ...
                                 />
                              <span
                                 v-if="form.errors.preorder_level_qty"
                                 class="mt-2 text-red-500"
                                 >
                              {{ form.errors.preorder_level_qty }}
                              </span>
                           </div>
                        </div>
                        ...
                        <!-- <div class="mt-6 p-6 bg-gray-800 rounded-xl shadow-md border border-gray-700">
                           ...
                           <div class="flex flex-col md:flex-row items-center gap-8">
                              ...
                              <div class="w-full">
                                 <label for="wholesale_discount" class="block text-md font-medium text-gray-300">
                                 Wholesale Discount (%):
                                 </label>
                                 <input
                                    type="text"
                              ...
                              <div class="w-full">
                                 <label for="final_whole_price" class="block text-md font-medium text-gray-300">
                                 Final Whole Price:
                                 </label>
                                 <input
                                    type="text"
                              ...
                              <div class="w-full">
                                 <label
                                    for="certificate"
                                    class="block text-md font-medium text-gray-300"
                                    >Upload Certificate (PDF, Image):</label>
                                 <input
                                    type="file"
                                    id="certificate"
                                    ...
                                    class="w-full px-4 py-2 mt-2 text-white bg-gray-800 rounded-md focus:outline-none focus:ring focus:ring-blue-600"
                                    />
                                 <span v-if="form.errors.certificate" class="mt-2 text-red-500">
                     ...
                     <div class="mt-4 space-x-4">
                        <button
                           class="px-8 py-2 text-white bg-blue-600 rounded hover:bg-blue-700"
                           type="submit"
                           >
                        Save
                        </button>
                        <button
                           class="px-8 py-2 text-gray-700 bg-gray-300 rounded hover:bg-gray-400"
                           @click="
                           () => {
...
<script setup>
   ...
   const form = useForm({
     ...
     batch_no: "",
     purchase_date: null,
     expiry_date_margin: null,
     preorder_level_qty: null,
     certificate: null,
